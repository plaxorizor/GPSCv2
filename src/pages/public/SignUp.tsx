...
import qr_maya from "./qr/maya.jpg";
import qr_gcash from "./qr/gcash.png";
...
const PAYMENT_INFO = {
    ...
    accounts: [
        { label: "GCash", accountName: "Faith Shield Care Official", number: "09XX-XXX-XXXX", qr: qr_gcash },
        { label: "Maya", accountName: "Faith Shield Care Official", number: "09XX-XXX-XXXX", qr: qr_maya },
