...
import { ArrowRight, Check, CheckCircle, HandHeart, Menu, Quote, Sparkles, Sprout, Users, X } from "lucide-react";
...
const LogoLockup: React.FC<LogoLockupProps> = ({ size = 40, dark = false }) => (
    <div className="flex items-center gap-3">
        ...
        <div className="leading-tight">
            <div className={`font-display font-semibold text-base tracking-tight ${dark ? "text-white" : "text-gpsc-navy"}`}>Green Pasture</div>
            <div className={`font-display italic text-sm ${dark ? "text-white/70" : "text-gpsc-green"}`}>Shepherd's Care</div>
        </div>
    </div>
);
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-white/70">
                        <li>
                            <button onClick={() => alert("Membership packages")}>Membership packages</button>
                        </li>
                        <li>
                            <button onClick={() => alert("Referral program")}>Referral program</button>
                        </li>
                        <li>
                            <button onClick={() => alert("Benefits & claims")}>Benefits & claims</button>
                        </li>
                        <li>
                            <button onClick={() => alert("Livelihood programs")}>Livelihood programs</button>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-white/70">
                        ...
                        <li>
                            <button onClick={() => alert("Officers & board")}>Officers & board</button>
                        </li>
                        <li>
                            <button onClick={() => alert("Press")}>Press</button>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-white/70">
                        ...
                        <li>
                            <button onClick={() => alert("Data privacy")}>Data privacy</button>
                        </li>
                        <li>
                            <button onClick={() => alert("Refund policy")}>Refund policy</button>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 items-center">
                        <div className="lg:col-span-7 anim-fade-up">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-xs tracking-[0.2em] uppercase text-gpsc-green font-medium">A community-owned safety net</span>
                            </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="group">
                                ...
                                <div
                                    className={`w-14 h-14 rounded-full ${pillar.color === "navy" ? "bg-gpsc-navy" : "bg-gpsc-green"} text-white flex items-center justify-center mb-6 group-hover:scale-105 transition-transform`}
                                >
                                    <pillar.icon size={24} />
                                </div>
                        ...
                        <div className="lg:col-span-8 space-y-8">
                            {[
                                ...
                                <div key={i} className="flex gap-6 group">
                                    <div className="font-display text-4xl text-gpsc-green/40 group-hover:text-gpsc-green transition-colors w-16 flex-shrink-0">
                                        {step.n}
                                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {packages.map((pkg) => (
                            ...
                            >
                                ...
                                <div
                                    className={`text-xs tracking-widest uppercase mb-2 ${pkg.popular ? "text-gpsc-green-light" : "text-gpsc-green"}`}
                                >
                                    {pkg.coverage}
                                </div>
                                <h3 className={`font-display text-3xl mb-2 ${pkg.popular ? "text-white" : "text-gpsc-navy"}`}>{pkg.name}</h3>
                                <p className={`text-sm mb-6 italic ${pkg.popular ? "text-white/70" : "text-gpsc-stone"}`}>{pkg.tagline}</p>
                                <div className="mb-8">
                                ...
                                <ul className="space-y-3 mb-8">
                                    {pkg.benefits.slice(0, 5).map((b, i) => (
                                        <li key={i} className="flex items-start gap-3 text-sm">
                                            <Check
                                                size={16}
                                                className={`mt-0.5 flex-shrink-0 ${pkg.popular ? "text-gpsc-green-light" : "text-gpsc-green"}`}
                                            />
                                            <div>
            ...
            <section className="gpsc-cream">
                <div className="max-w-4xl mx-auto px-6 lg:px-8 py-24 text-center">
                    ...
                    <p className="font-display text-3xl lg:text-4xl text-gpsc-navy leading-snug italic">
                        "When my husband was admitted last February, GPSC released ₱11,500 in four days. No paperwork chaos, no waiting weeks. Now I
                        refer everyone in our barangay — it's how we take care of each other."
                    </p>
                    <div className="mt-10 flex items-center justify-center gap-4">
                        <div className="w-12 h-12 rounded-full bg-gpsc-navy text-white flex items-center justify-center font-display text-sm">MD</div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-white/70 leading-relaxed">
                                Every officer, registration, and benefit payout is on the record. We publish audited financials annually and welcome
