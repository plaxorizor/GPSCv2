    ...
    <div className="min-h-screen font-body text-gpsc-ink antialiased">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <p className="text-gpsc-stone">
          Earn 20% commission on direct referrals plus overrides from your downline. Unlock higher ranks
          like Team Consultant, Sales Manager, and National Director as your team grows.
        </p>
      </main>
      <Footer />
    </div>
