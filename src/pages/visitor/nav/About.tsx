    ...
    <div className="min-h-screen font-body text-gpsc-ink antialiased">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20">
        ...
        <p className="text-gpsc-stone">
          Green Pasture Shepherd's Care is a community-owned membership program dedicated to providing
          financial assistance, livelihood opportunities, and a supportive network for Filipino families.
        </p>
      </main>
      <Footer />
    </div>
