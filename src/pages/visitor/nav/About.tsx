            ...
            <section className="border-fsc-cream-dark border-t bg-white">
                <div className="mx-auto max-w-4xl px-6 py-20 lg:px-8">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
                        {[
                            { role: "CEO / President",            initials: "CP", note: "Governance, strategy, partnerships" },
                            { role: "VP for Finance / Treasurer", initials: "VF", note: "Financial management, audit" },
                            { role: "VP for Sales & Marketing",   initials: "VS", note: "Operations, growth, member acquisition" },
                            { role: "Secretary",                  initials: "SC", note: "Records, governance documents" },
                            { role: "Auditor",                    initials: "AU", note: "Independent financial review" },
                            { role: "Public Relations Officer",   initials: "PR", note: "Communications, community" },
                        ].map((officer, i) => (
                            <div key={i} className="border-fsc-cream-dark rounded-2xl border p-5">
                                ...
                                <div className="font-display text-fsc-navy text-base">{officer.role}</div>
                                <div className="text-fsc-stone mt-1 text-sm">{officer.note}</div>
                                <div className="text-fsc-stone mt-3 text-xs italic">Name to be added</div>
                            </div>
                        ))}
                    </div>
                </div>
