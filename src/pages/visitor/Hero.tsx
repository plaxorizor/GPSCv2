          ...
          <div className="lg:col-span-7 anim-fade-up">
            ...
            <div className="mt-10 flex flex-wrap gap-4 items-center">
              <button
                ...
                className="bg-gpsc-navy text-white px-8 py-4 rounded-full font-medium hover:bg-gpsc-green transition-colors inline-flex items-center gap-2 group cursor-pointer"
              >
                Become a member
              ...
              <button
                ...
                className="border border-gpsc-navy px-8 py-4 rounded-full font-medium transition-colors cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 relative anim-fade-up anim-delay-200">
            <div className="aspect-square relative">
              ...
              <div className="absolute inset-16 rounded-full bg-gradient-to-br from-gpsc-cream-dark to-transparent flex items-center justify-center">
                <img src={logo} alt="GPSC Logo" className="w-44 h-44 object-contain rounded-full mix-blend-multiply" />
              </div>
