...
export const StatCard: React.FC<StatCardProps> = ({ label, value, sub, icon: Icon, actionLabel, onAction }) => (
  <div className="bg-white rounded-2xl p-5 border border-gpsc-cream-dark transition-all hover:shadow-sm">
    ...
    {actionLabel && onAction && (
      <button onClick={onAction} className="text-xs text-gpsc-green mt-3 hover:underline inline-flex items-center gap-1">
