...
export default function AdminArea() {
  ...
  if (authLoading) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gpsc-cream">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-gpsc-green"></div>
      </div>
    );
  }
