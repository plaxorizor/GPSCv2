    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm" onClick={onClose}>
            ...
            >
                ...
                <h2 className="font-display text-fsc-navy text-2xl">Welcome to the Faith Shield Care Family!</h2>
                <div className="text-fsc-stone mt-4 space-y-4 text-left text-sm leading-relaxed">
                    ...
                    <p>Thank you for joining Faith Shield Care. We look forward to serving you with excellence, integrity, and compassion.</p>
                </div>
