                        ...
                        {commissions.map((c) => (
                            <tr key={c.id} className="border-gpsc-cream-dark border-t">
                                ...
                                <td className="p-4 text-right">
                                    <span
                                        className={`rounded-full px-2 py-1 text-xs ${c.status === "paid" ? "bg-gpsc-green/10 text-gpsc-green" : c.status === "payable" ? "bg-gpsc-navy/10 text-gpsc-navy" : "bg-amber-100 text-amber-700"}`}
                                    >
                                        {c.status}
                                    </span>
                                </td>
